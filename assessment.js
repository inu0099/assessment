...
function removeAllChildren(element) {
    while(element.firstChild) { // 子供の要素がある限り全て削除
...
assessmentButton.onclick = () => {
    ...
    return;
        ...
        console.log(userName + 'という名前でボタンが押されました');
    }
    ...
    const hrefValue = 'https://twitter.com/intent/twwet?button_hashtag=あなたのいいところ&ref_src=twsrc%5Etfw';
